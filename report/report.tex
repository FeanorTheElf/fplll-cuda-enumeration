    ...
    \begin{figure}[H]
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot+[only marks, mark=x, red] table[x expr=\coordindex + 1, y=time] {bkz_times_cu.dat} node[above, pos=.7] {};
                \addplot+[only marks, mark=x, blue] table[x expr=\coordindex + 1, y=time] {bkz_times_mt.dat} node[left, pos=.88] {};
                
                \addplot+[mark=none, red] table[x expr=\coordindex + 1, y=avg] {bkz_times_cu.dat} node[right, pos=.6] {CUDA (avg)};
                \addplot+[mark=none, blue] table[x expr=\coordindex + 1, y=avg] {bkz_times_mt.dat} node[right, pos=.2] {Multithreaded (avg)};
