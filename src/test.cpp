...
#endif
        test_small();
        std::cout << "test_small() successful!" << std::endl
                  << std::endl;
        test_knapsack();
        std::cout << "test_knapsack() successful!" << std::endl
                  << std::endl;
        test_small_pruning();
        std::cout << "test_small_pruning() successful!" << std::endl
                  << std::endl;
#ifdef PERF_TEST
        test_perf();
        std::cout << "test_perf() successful!" << std::endl
                  << std::endl;
        test_perf_pruning();
        std::cout << "test_perf_pruning() successful!" << std::endl
                  << std::endl;
#endif
        std::cout << "=============" << std::endl;
